  ...
  return (
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          ...
          <div className="flex flex-col items-center px-26 py-1.5 text-center">
            <div className="mb-1">
              <Link href="/">
                <Image
                ...
                <Image
                  ...
                  src={"/images/logo/lyzoo-logo.png"}
                  alt="Logo"
                  width={190}
                  height={32}
                />
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
             ...
             <DarkModeSwitcher />
            {/* <!-- Dark Mode Toggler --> */}
            <span className="mb-1.5 block font-medium">Welcome <span className="text-violet-500">Admin</span> </span>
            <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
              ...
              {error && <p className="text-pink-500">{error}</p>}
               ...
               >
                  ...
                  ></span>
                  <span
                    className="absolute w-full h-32 -top-8 -left-2 bg-green-400 rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-700 duration-700 origin-bottom"
                  ></span>
                  <span
                    className="absolute w-full h-32 -top-8 -left-2 bg-green-600 rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-1000 duration-500 origin-bottom"
                  ></span>
                  <span
                    className="group-hover:opacity-100 group-hover:duration-1000 duration-100 opacity-0 absolute top-2.5 text-xl z-10"
                    >➡ Ready to Sign Up!</span>
              </button>
                </div>

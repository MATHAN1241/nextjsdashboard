...
const Attendanceviewthree = () => {
  return (
    <React.Fragment>
    <Breadcrumb pageName="Attendance viewpage-3"/>
               ...
               <tr >
                <td className="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                  ...
                  <div>
                   ...
                   <p className="text-black dark:text-white">Peter</p>
                 </div>
                </td>
                ...
                <td className="border-b border-[#eee] px-6 py-5 dark:border-strokedark">
                  <p className="text-black dark:text-white">Team Lead</p>
                </td>
                <td className="border-b border-[#eee] px-6 py-5 dark:border-strokedark">
                  <p className="text-black dark:text-white">
                    $70,000
                ...
                <td className="border-b border-[#eee] px-6 py-5 dark:border-strokedark">
                  <p className="text-black dark:text-white">05-04-2024</p>
                </td>
...
export default Attendanceviewthree
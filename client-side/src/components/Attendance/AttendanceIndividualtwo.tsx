...
const Attendanceviewtwo = () => {
  return (
    <React.Fragment>
    <Breadcrumb pageName="Attendance viewpage-2"/>
               ...
               <tr >
                <td className="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                  ...
                  <div>
                   ...
                   <p className="text-black dark:text-white">Monika</p>
                 </div>
                </td>
                ...
                <td className="border-b border-[#eee] px-6 py-5 dark:border-strokedark">
                  <p className="text-black dark:text-white">Telemarketing Executive</p>
                </td>
                <td className="border-b border-[#eee] px-6 py-5 dark:border-strokedark">
                  <p className="text-black dark:text-white">
                    $50,000
...
export default Attendanceviewtwo
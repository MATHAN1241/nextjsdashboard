        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
             ...
             < p className="font-medium">Danish123@gmail.com</p>
             <br/>
              <Link href={'profile/Profileformpage'}>
              <button className="hover:text-primary   rounded bg-primary px-2 py-1 text-sm font-medium text-white hover:bg-opacity-80 xsm:px-4">
              ...
              <div className="mx-auto max-w-180">
                <h4 className="font-semibold text-black dark:text-white py-5">
                  About Me
                </h4>
                <p className="mt-4.5 py-0">

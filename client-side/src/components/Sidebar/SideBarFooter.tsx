    ...
    return(
        ...
        <div className="card">
            ...
            <div className="content">
                <span className="title">Lyzoo < br /> Technologies</span>
                <span className="text">Securing Your Value Is Our Business</span>
            </div>
            <div className="bottom">
                ...
                <div className="view-more">
                        <a href="tel:+919043334324">
                        <button className="view-more-button">Call Us</button>
                        </a>

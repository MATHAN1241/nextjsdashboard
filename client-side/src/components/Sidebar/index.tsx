...
const Sidebar = ({ sidebarOpen, setSidebarOpen}: SidebarProps) => {
  ...
  // console.log("Ysername: ",name1);
  // console.log("Yemail:", email1);
  // console.log("Yid:", id1);
  // const {id, email, name, category } = useSelector((state: RootState) => state.user);
  ...
  //        console.log(user)
  //         // Access the category property from the user object
  //         const userCategory = user.category;
  //         // Update the state with the user category
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/dashboard">
          <Image
            width={176}
            height={32}
            src={"/images/logo/lyzoo-logo-dark.png"}
            alt="Logo"
            ...
            <div>
              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                  ...
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
                        <Link
                          href="/dashboard"
                          className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === "/dashboard" || pathname.includes("dashboard")) &&
                ...
                <li>
                  <Link
                    href="/employees"
                    className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("employees") &&
                      "bg-graydark dark:bg-meta-4"
                      }`}
                  >
<<<<<<< HEAD
                ...
                <li>
                  <Link
                    href="/attendance"
                    className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("attendance") &&
                      "bg-graydark dark:bg-meta-4"
                      }`}
                  >
                    <svg
                ...
                {/* <!-- Menu Item Attendance --> */}
                {/* <!-- Menu Item Leave Request --> */}
                <li>
                  <Link
                    href="/LeaveRequest"
                    className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("leave request") &&
                      "bg-graydark dark:bg-meta-4"
                      }`}
                  >
                    <svg
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <rect x="1.5" y="4.5" width="15" height="1.5" fill="white" />
                      <rect x="1.5" y="7.5" width="15" height="1.5" fill="white" />
                      <rect x="1.5" y="10.5" width="15" height="1.5" fill="white" />
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/AdminAppraisal/AssignApproval"
                          ...
                          <li>
                            <Link
                              href="/AdminAppraisal/ApprovalAppraisal"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                          ...
                          <li>
                            <Link
                              href="/AdminAppraisal/PublicAppraisal"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/forms/form-layout" &&
                                "text-white"
                              } `}
...
>>>>>>> a6f22f3f6eddfbd2a101691e0effabdf6d4a98ec
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/Employeeattendance?_id=567829"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("attendance") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("employee leave request") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
                  ...
                  return (
                    <React.Fragment>
                      <Link
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === "/appraisal" ||
                            pathname.includes("employeeAppraisal")) &&
                          "bg-graydark dark:bg-meta-4"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "appraisal/appraisalRequest" &&
                                "text-white"
                              }`}
                            >
                            Appraisal Request
                          ...
                          <li>
                            <Link
                              href="/appraisal/appraisalView"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/appraisal/appraisalView" &&
                                "text-white"
                              } `}
                            >
                             Appraisal View
...
=======
 ...
 <li>
                <Link
                  href="/EmployeeCalender"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("EmployeeCalendar") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
...
>>>>>>> a6f22f3f6eddfbd2a101691e0effabdf6d4a98ec
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path d="M3 6v12a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6H3z" />
                    <line x1="9" y1="3" x2="15" y2="3" />
                    <line x1="10" y1="9" x2="14" y2="9" />
                    <line x1="10" y1="13" x2="14" y2="13" />
                    <line x1="4" y1="7" x2="4" y2="5" />
                  </svg>
                  Bank Details
                </Link>
              </li>
